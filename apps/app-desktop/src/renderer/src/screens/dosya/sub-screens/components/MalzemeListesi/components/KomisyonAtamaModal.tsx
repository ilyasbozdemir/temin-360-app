        ...
        {activeTab === "yaklasik_maliyet" ? (
          <>
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-blue-700 hover:bg-blue-800 active:scale-95 text-white rounded-lg text-xs font-bold transition-all shadow-xs cursor-pointer disabled:opacity-50"
          ...
          <button
            ...
            disabled={saving || loading}
            className="flex items-center gap-2 px-4 py-2 bg-blue-700 hover:bg-blue-800 active:scale-95 text-white rounded-lg text-xs font-bold transition-all shadow-xs cursor-pointer disabled:opacity-50"
          >
            <FileText className="w-3.5 h-3.5" />
