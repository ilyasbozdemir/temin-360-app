                    ...
                    >
                      ...
                      <td className="px-3 py-2 text-right whitespace-nowrap">
                        <div className="inline-flex items-center gap-1.5 justify-end">
                          {/* 1. Teklif Mektubu Aç Butonu */}
                          {onFiyatPiyasaFormu && (
                            <button
                              type="button"
                              onClick={() => onFiyatPiyasaFormu(firma)}
                              className="px-2 py-1 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 dark:bg-blue-950/50 dark:text-blue-300 dark:hover:bg-blue-900/60 text-[11px] font-bold transition-colors cursor-pointer border border-blue-200/60 dark:border-blue-800/40 flex items-center gap-1"
                              title={`${firma.unvan} için Teklif İsteme Mektubunu Aç`}
                            >
