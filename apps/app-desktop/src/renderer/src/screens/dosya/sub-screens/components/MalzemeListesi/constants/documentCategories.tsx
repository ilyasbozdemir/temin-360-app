...
export function buildDocumentCategories(
  ...
  const rawCategories: PopoverCategoryConfig[] = [
    ...
    {
      id: "komisyon",
      title: "Komisyon Belgeleri & Kadro",
      icon: Users,
      ...
      items: [
        {
          ...
          label: "Yaklaşık Maliyet Komisyon Kadrosu",
          icon: Users,
        ...
        },
        {
          ...
          label: "Muayene Kabul Komisyon Kadrosu",
          icon: UserCheck,
        ...
        {
          id: "gorevlendirmeAtamaOnayEki",
          label: "Komisyon Atama Onay Eki",
          icon: FileCheck,
          iconColorClass: "text-blue-500",
        ...
        },
        {
          ...
          label: "Piyasa Fiyat Araştırma Görevlendirmesi",
          icon: UserCheck,
          iconColorClass: "text-blue-500",
