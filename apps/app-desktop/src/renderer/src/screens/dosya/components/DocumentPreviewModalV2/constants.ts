...
export const V2_TEMPLATES_MAP: Record<string, TemplateComponentType> = {
  ...
  TasinirKayitYetkilisiGorusu: Templates.TasinirKayitYetkilisiGorusu as TemplateComponentType,
  ...
  PiyasaFiyatArastirmaGorevlendirmesi:
    Templates.PiyasaFiyatArastirmaGorevlendirmesi as TemplateComponentType,
