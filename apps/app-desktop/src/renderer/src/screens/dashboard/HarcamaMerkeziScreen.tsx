...
export default function HarcamaMerkeziScreen(): React.JSX.Element {
  ...
  const [simulatedWorkType, setSimulatedWorkType] = useState<'mal' | 'hizmet' | 'yapim'>('mal')
  ...
  const MODULES = [
    {
      ...
      gradient: 'from-amber-500/10 via-amber-500/5 to-transparent border-amber-500/30',
    ...
    },
    {
      ...
      gradient: 'from-blue-500/10 via-blue-500/5 to-transparent border-blue-500/30',
    ...
    },
    {
      ...
      gradient: 'from-emerald-500/10 via-emerald-500/5 to-transparent border-emerald-500/30',
    ...
    },
    {
      ...
      gradient: 'from-indigo-500/10 via-indigo-500/5 to-transparent border-indigo-500/30',
          ...
          <div className="space-y-3 max-w-3xl">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-3 py-1 rounded-full text-xs font-black bg-indigo-500/20 text-indigo-300 border border-indigo-500/40 flex items-center gap-1.5 uppercase tracking-wider">
                <Landmark className="w-3.5 h-3.5" /> TEMİN 360 • Harcama & Hakediş Merkezi
              </span>
              <span className="px-3 py-1 rounded-full text-xs font-bold bg-amber-500/20 text-amber-300 border border-amber-500/40 flex items-center gap-1.5">
                <ShieldCheck className="w-3.5 h-3.5" /> 4734 / 4735 / 5018 Sayılı Mevzuat Uyumlu
              </span>
            ...
            <p className="text-sm text-slate-300 leading-relaxed font-normal">
              Doğrudan teminden anahtar teslimi yapım işlerine, İller Bankası pursantajlı
              hakedişlerinden mal ve hizmet kabul evraklarına kadar tüm kamu mali süreçlerini tek
              ekrandan yönetin.
            </p>

            <div className="flex items-center gap-6 pt-2 text-xs text-slate-400 font-medium">
              <span className="flex items-center gap-1.5">
                <strong className="text-white font-bold">{institutionName || 'Kurum Adı'}</strong>
              </span>
              <span>•</span>
              <span className="flex items-center gap-1.5">
              ...
              <span>
                Aktif Kayıtlı Dosya:
                <strong className="text-indigo-300 font-bold ml-1">{dosyalar.length} Adet</strong>
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full sm:w-auto shrink-0">
            ...
            <div className="flex items-center gap-2">
              <Link to="/" className="flex-1">
                ...
                >
                  <LayoutDashboard className="w-3.5 h-3.5 text-indigo-400" /> Klasik Panel
                </Button>
              </Link>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              İhtiyacınıza uygun iş türünü seçin, sistem ilgili şartnameye ve İller Bankası
              standartlarına göre evrak setini otomatik oluştursun.
            </p>
          </div>
        </div>
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="text-base md:text-lg font-black text-white">
                  4734 Sayılı Kamu İhale Kanunu: İhale Usulü ve Bütçe Karar Matrisi
                </h3>
              ...
              <p className="text-xs text-slate-300 mt-0.5">
                Bütçe tutarınıza göre Açık İhale mi, Pazarlık Usulü mü yoksa Doğrudan Temin mi
                uygulanacağını anında tespit edin.
              </p>
            </div>
          </div>
          <Link to="/mevzuat">
            ...
            >
              <Scale className="w-3.5 h-3.5 mr-1 text-amber-400" /> KİK Tebliği ve Eşik Değerler
            </Button>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-5 p-5 rounded-2xl bg-slate-950/80 border border-indigo-500/20 flex flex-col justify-between gap-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <label className="text-xs font-bold text-slate-200 flex items-center gap-1.5">
                  <Calculator className="w-4 h-4 text-indigo-400" /> Tahmini Alım / Hakediş Bütçesi
                  (TL)
                </label>
                <span className="text-[10px] font-mono text-slate-400">KDV Hariç</span>
              </div>
              <div className="relative">
                <Input
                  type="number"
                  value={simulatedBudget}
                  onChange={(e) => setSimulatedBudget(Number(e.target.value) || 0)}
                  ...
                  {[
                    ...
                    return (
                      <button
                        key={t.id}
                        type="button"
                        onClick={() => setSimulatedWorkType(t.id as 'mal' | 'hizmet' | 'yapim')}
              ...
              <div className="flex items-center gap-1.5 flex-wrap pt-1">
                <span className="text-[10px] text-slate-400">Hızlı Değerler:</span>
                {[
            ...
            <div className="p-3 rounded-xl bg-indigo-950/40 border border-indigo-500/20 text-[11px] text-indigo-300 flex items-start gap-2">
              ...
              <span>
                ...
                <strong className="text-white ml-1 font-mono">{formatCurrency(activeLimit)}</strong>
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 p-6 rounded-2xl bg-slate-950/90 border border-indigo-500/30 flex flex-col justify-between space-y-4">
            <div>
              ...
              {simulatedBudget <= activeLimit ? (
                <div className="mt-4 p-4 rounded-2xl bg-emerald-950/40 border border-emerald-500/40 space-y-2">
                  ...
                  <h4 className="text-sm font-bold text-white">
                    Bu alım ihale açılmaksızın doğrudan temin usulüyle yapılabilir.
                  </h4>
                  <p className="text-xs text-emerald-200/80 leading-relaxed">
                    İlan ve teminat alma zorunluluğu yoktur. İhale komisyonu kurulması zorunlu
                    değildir; harcama yetkilisince görevlendirilecek personel piyasa fiyat
                    araştırması yaparak onay belgesi düzenleyebilir.
                  </p>
                </div>
                ...
                <div className="mt-4 p-4 rounded-2xl bg-amber-950/40 border border-amber-500/40 space-y-2">
                  ...
                  <p className="text-xs text-amber-200/80 leading-relaxed">
                    Bu tutar tek seferde doğrudan teminle karşılanamaz. KİK Md. 21/f pazarlık usulü
                    (ilan yapılmaksızın en az 3 istekli davetiyle) veya Md. 19 Açık İhale usulü
                    tercih edilmelidir. İhale komisyonu ve %6 kesin teminat şarttır.
                  </p>
                </div>
              ) : (
                <div className="mt-4 p-4 rounded-2xl bg-blue-950/40 border border-blue-500/40 space-y-2">
                  ...
                  <h4 className="text-sm font-bold text-white">
                    Yüksek tutarlı alım: EKAP üzerinden Açık İhale ilanı zorunludur.
                  </h4>
                  <p className="text-xs text-blue-200/80 leading-relaxed">
                    Tüm isteklilere açık EKAP ilanı verilmeli, kanuni ilan askı süreleri (14/21/40
                    gün) beklenmeli, %3 geçici teminat ve %6 kesin teminat tahsil edilmelidir.
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-4 text-[11px]">
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-400 block text-[10px]">EKAP İlanı:</span>
                  <strong className="text-white">
                    {simulatedBudget <= activeLimit ? '❌ Aranmaz' : '✅ Zorunlu'}
                  </strong>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-400 block text-[10px]">Teminat:</span>
                  <strong className="text-white">
                    {simulatedBudget <= activeLimit ? '❌ Aranmaz' : '✅ %6 Kesin Teminat'}
                  </strong>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-400 block text-[10px]">İhale Komisyonu:</span>
                  <strong className="text-white">
                    {simulatedBudget <= activeLimit ? '❌ İsteğe Bağlı' : '✅ Zorunlu'}
                  </strong>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-900 border border-slate-800">
                  <span className="text-slate-400 block text-[10px]">Hakediş / İcmal:</span>
                  <strong className="text-white">
                    {simulatedWorkType === 'yapim' || simulatedBudget > activeLimit
                      ? '✅ Zorunlu'
                      : '📄 Fatura / TİF'}
                  </strong>
                </div>
            ...
            <div className="pt-2 border-t border-slate-800 flex items-center justify-between">
              ...
              <Link to={simulatedBudget <= activeLimit ? '/dosyalar/yeni' : '/hakedis'}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-indigo-500/20">
          <div className="p-4 rounded-2xl bg-slate-950/60 border border-rose-500/30 space-y-1.5">
            <h4 className="text-xs font-extrabold text-rose-400 flex items-center gap-1.5 uppercase tracking-wider">
              <AlertTriangle className="w-4 h-4" /> KİK Madde 5: Kısımlara Bölme Yasağı
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
              Eşik değerlerin altında kalmak veya 22/d doğrudan temin limitini aşmamak amacıyla{' '}
              <strong>aynı nitelikteki bir iş parçalara bölünerek</strong> ayrı ayrı doğrudan
              teminle yapılamaz. Sayıştay denetimlerinde en çok zimmet çıkan konudur.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-950/60 border border-amber-500/30 space-y-1.5">
            <h4 className="text-xs font-extrabold text-amber-400 flex items-center gap-1.5 uppercase tracking-wider">
              <ShieldAlert className="w-4 h-4" /> KİK Madde 62/ı: %10 Bütçe Sınırı Kuralı
            </h4>
            <p className="text-[11px] text-slate-300 leading-relaxed">
              İdarelerin 21/f (pazarlık) ve 22/d (doğrudan temin) ile yapacakları harcamaların
              toplamı, o yılki toplam mal/hizmet bütçelerinin <strong>%10&apos;unu aşamaz</strong>.
              Aşılması durumunda önceden Kamu İhale Kurulu&apos;ndan (KİK) izin alınması zorunludur.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Neden hakediş ve harcama evrakları bu kadar katı kurallara bağlıdır?
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2">
            ...
            <p className="text-slate-300 leading-relaxed">
              İller Bankası mühendisleri ve belediye harcama yetkilileri, imzalanan hakedişlerdeki
              her kuruştan şahsi mal varlıklarıyla sorumludur. Eksik pursantaj veya hatalı yeşil
              defter doğrudan <strong>kamu zararı</strong> sayılır.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2">
            ...
            <p className="text-slate-300 leading-relaxed">
              SGK Borcu Yoktur, Vergi Borcu Yoktur, %5 Stopaj Kesintisi ve Damga Vergisi kesintisi
              olmadan hakediş vezneden çıkamaz. Sistem bu kesintileri kuruşu kuruşuna otomatik
              yapar.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2">
            ...
            <p className="text-slate-300 leading-relaxed">
              Beton kırım raporları, boru sızdırmazlık testleri ve şantiye ataşman defterleri
              hakedişin ayrılmaz ekidir. TEMİN 360 dizi pusulasında tüm ekleri eksiksiz
              numaralandırır.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Yapacağınız harcama veya hakedişin hangi kategoriye girdiğinden emin değil misiniz?
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                  Bina, asfalt, kilit parke, kanalizasyon, tadilat veya tesis yapımı.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                  Kırtasiye, akaryakıt, yedek parça, çimento, boru, bilgisayar vb.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                  Personel, temizlik, güvenlik, araç kiralama, bakım ve danışmanlık.
                </p>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                  KİK 22/d maddesi uyarınca komisyonsuz, hızlı onay belgesi ve piyasa araştırması
                  ile tek seferlik alım.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">
                  Pursantaj tablosu, hakediş icmali, fiyat farkı ve Sayıştay denetim kapakları
                  gerektiren taksitli süreç.
                </p>
              </button>
            </div>
          </div>
        ...
        {wizardStep === 2 && (
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-950 border border-indigo-200 dark:border-indigo-900 space-y-4">
            <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-bold text-xs">
              <CheckCircle2 className="w-4 h-4" /> Önerilen Süreç ve Evrak Seti Belirlendi
            </div>

            <h4 className="text-base font-extrabold text-slate-900 dark:text-slate-100">
              {wizardSelection.kategori === 'yapim' && wizardSelection.alimTuru === 'hakedis'
            ...
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              Seçtiğiniz parametrelere göre sistem arka planda gerekli mevzuat şablonlarını, dizi
              pusulası fihristini ve onay mercilerini otomatik hazırlayacaktır.
            </p>

            <div className="flex items-center gap-3 pt-2">
              <Link
                to={wizardSelection.alimTuru === 'dogrudan_temin' ? '/dosyalar/yeni' : '/hakedis'}
              >
